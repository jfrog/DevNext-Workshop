...
jf mvnc --server-id-resolve devnext --server-id-deploy devnext --repo-resolve-releases clear --repo-resolve-snapshots payment-maven-dev-virtual --repo-deploy-releases payment-maven-dev-virtual --repo-deploy-snapshots payment-maven-dev-virtual
